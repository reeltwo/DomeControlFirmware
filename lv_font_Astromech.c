...
#ifndef LV_FONT_ASTROMECH
#define LV_FONT_ASTROMECH 1
#endif

#if LV_FONT_ASTROMECH
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t lv_font_Astromech = {
#else
lv_font_t lv_font_Astromech = {
#endif
